  ...
  export class WorkerMetric extends Metric {
    ...
    Worker: {
      new (url: any, options: any, ...args: any[]): {
        ...
        removeEventListener<K_1 extends keyof WorkerEventMap>(
          type: K_1,
          listener: (this: Worker, ev: WorkerEventMap[K_1]) => any,
...
declare module "socket:diagnostics/index" {
  ...
  export function channel(
    name: string
  ): import("socket:diagnostics/channels").Channel;
...
declare module "socket:internal/events" {
  ...
  export class MenuItemEvent extends MessageEvent<any> {
    ...
    constructor(
      ...
      menu?: import("../application/menu.js").Menu
    );
    /**
...
declare module "socket:fs/handle" {
  ...
  export class DirectoryHandle extends EventEmitter {
     ...
     */
    static from(
      id: string | number | DirectoryHandle | object
    ): DirectoryHandle;
    /**
...
declare module "socket:fs/index" {
  ...
  export function open(
    ...
    mode?: string | null,
    options?: any,
    callback?: ((arg0: Error | null, arg1: number | null) => any) | null
  ): void;
  /**
  ...
  export function opendir(
    path: string | Buffer | URL,
    options: {},
    callback: ((arg0: Error | null, arg1: Dir | null) => any) | null
  ): void;
  /**
  ...
  export function read(
    fd: number,
    buffer: object | Buffer | TypedArray,
    offset: number,
    length: number,
  ...
  export function readdir(
    path: string | Buffer | URL,
    options: {},
    callback: (arg0: Error | null, arg1: object[]) => any
  ): void;
  /**
  ...
  export function readFile(
    ...
    options: {},
    callback: (arg0: Error | null, arg1: Buffer | null) => any
  ): void;
  /**
   * @param {string | Buffer | URL | number } path
   * @param {object?|function(Error?, Buffer?)} [options]
  ...
  export function readlink(
    path: string,
    callback: (arg0: err, arg1: string) => any
  ): void;
  /**
   * Computes real path for `path`
   * @param {string} path
  ...
  export function stat(
    path: string | Buffer | URL | number,
    options: object | null,
    callback: (arg0: Error | null, arg1: Stats | null) => any
  ): void;
  /**
   * Get the stats of a symbolic link
   * @param {string | Buffer | URL | number } path - filename or file descriptor
...
declare module "socket:errors" {
  ...
  export class ErrnoError extends Error {
     ...
     */
    constructor(
      code: import("./errno.js").errno | string,
      message?: any,
      ...args: any[]
    );
    get name(): string;
...
declare module "socket:window" {
  ...
  export class ApplicationWindow {
    ...
    constructor({ index, ...options }: { [x: string]: any; index: any });
    /**
...
declare module "socket:internal/shared-worker" {
  export function getSharedWorkerImplementationForPlatform():
    ...
    | typeof SharedHybridWorkerProxy
    | typeof SharedHybridWorker;
...
declare module "socket:commonjs/package" {
  ...
  export type PackageLoadOptions =
    import("socket:commonjs/loader").RequestOptions & {
      type?: "commonjs" | "module";
      prefix?: string;
    };
  /**
...
declare module "socket:vm" {
  ...
  export function getContextWindow(): Promise<
    import("socket:window").ApplicationWindow
  >;
  /**
...
declare module "socket:worker_threads" {
  ...
  export class Worker extends EventEmitter {
    ...
    onProcessEnvironmentEvent(
      event: import("./process.js").ProcessEnvironmentEvent
    ): void;
    /**
...
declare module "socket:dns/index" {
  ...
  export function lookup(
    hostname: string,
    options?: (object | intenumberger) | undefined,
    cb: Function
  ): void;
  export { promises };
  export default exports;
...
declare module "socket:dgram" {
  ...
  export class Socket extends EventEmitter {
    ...
    dataListener: ({ detail }: { detail: any }) => any;
    /**
...
declare module "socket:http/adapters" {
  ...
  export class ServiceWorkerServerAdapter extends ServerAdapter {
     ...
     */
    onInstall(
      event: import("../service-worker/events.js").ExtendableEvent
    ): Promise<void>;
    /**
...
declare module "socket:stream-relay/packets" {
  ...
  export class PacketSync extends Packet {
    static type: number;
    constructor({ packetId, message }: { packetId: any; message?: any });
  }
...
declare module "socket:timers/index" {
  export function setTimeout(
    ...
    delay: any,
    ...args: any[]
  ): import("socket:timers/timer").Timer;
...
declare module "socket:commonjs/require" {
  ...
  export type RequireResolver = (
    arg0: string,
    arg1: import("socket:commonjs/module").Module,
  ...
  export type PackageResolveOptions =
    import("socket:commonjs/package").PackageResolveOptions;
...
declare module "socket:commonjs/module" {
  ...
  export type RequireFunction =
    import("socket:commonjs/require").RequireFunction;
  export type PackageOptions = import("socket:commonjs/package").PackageOptions;
  export type CreateRequireOptions = {
    prefix?: string;
    request?: import("socket:commonjs/loader").RequestOptions;
...
declare module "socket:module" {
  ...
  export type ModuleLoadOptions =
    import("socket:commonjs/module").ModuleLoadOptions;
  export type RequireFunction =
    import("socket:commonjs/module").RequireFunction;
  export type CreateRequireOptions =
    import("socket:commonjs/module").CreateRequireOptions;
...
declare module "socket:npm/service-worker" {
  ...
  export default function _default(
    request: Request,
    env: object,
    ctx: import("socket:service-worker/context").Context
  ): Response | null;
}
...
declare function isArrayBuffer(object: any): boolean;
declare function findMessageTransfers(
  transfers: any,
  object: any,
  options?: any
): any;
...
declare module "socket:test/harness" {
   ...
   */
  export function wrapHarness<T extends exports.Harness>(
    tapzero: typeof import("socket:test/index"),
    harnessClass: new (options: object) => T
  ): exports.TapeTestFn<T>;
  export default exports;
  /**
   * @template {Harness} T
   */
